...
$(function(){
    ...
    function a(arr,op,switchArry){
        ...
        obj.onload=function(){
            ...
            for(var i=0 ;i < switchArry.length;i++){
    ...
    function checkCookie(){
        ...
        console.log('分组'+username)
        console.log('下标'+uservalue)
        console.log('透明'+opa)
        ...
        if (username!=""&&uservalue!=""&&opa!=''&&Cache_lm!=''){
            ...
            username=='Anime'?a(Anime[uservalue],opa,switchArry):a(landscape[uservalue],opa,switchArry);
        }else{
            //初始化cookie...
            console.log('开始初始化..')
